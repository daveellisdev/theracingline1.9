...
//    @Published var storeReturnedMessage = "No Messages"
//
//    @Published var isValid = false
//    @Published var base64 = ""
//    @Published var hasPurchases = false
//    @Published var hasActiveAutoRenewablePurchases = false
//
//    @Published var purchases: [InAppPurchase] = []
//    @Published var autoRenewablePurchases: [InAppPurchase] = []
//    @Published var activeAutoRenewableSubscriptionPurchases: [InAppPurchase] = []
//
//
//
//
...
//            if let err = error {
//                self.subscribed = false
//                self.storeReturnedMessage = err.localizedDescription
//                print(err)
//            } else {
//            // do your stuff with the receipt data here
//                if let receipt = try? InAppReceipt.localReceipt(){
//                    self.isValid = receipt.isValid
//                    self.base64 = receipt.base64
//                    self.hasPurchases = receipt.hasPurchases
//                    self.hasActiveAutoRenewablePurchases = receipt.hasActiveAutoRenewablePurchases
//
...
//                        self.subscribed = true
//                        self.storeReturnedMessage = "Annual Subscription Found"
...
//                        // user has subscription of the product, which is still active at the specified date
//                        self.subscribed = true
//                        self.storeReturnedMessage = "Monthly Subscription Found"
...
//                        // user has subscription of the product, which is still active at the specified date
//                        self.storeReturnedMessage = "Deprecated Silver Subscription Found"
//                        self.subscribed = false
//
//                    } else if receipt.hasActiveAutoRenewableSubscription(ofProductIdentifier: "dev.daveellis.theracingline.bronze", forDate: Date()) {
//                        // user has subscription of the product, which is still active at the specified date
//                        self.storeReturnedMessage = "Deprecated Bronze Subscription Found"
//                        self.subscribed = false
//
//                    } else {
//                        self.subscribed = false
//                        self.storeReturnedMessage = "No Subscription Found"
